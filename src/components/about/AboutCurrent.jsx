  ...
  return (
    <section className="about-current relative -mt-24 py-56 bg-black/70 overflow-hidden z-50">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-10">
        <ChapterFrame index={6} label="CURRENT">

          <Reveal y={30}>
            <p className="uppercase tracking-[0.45em] text-[#5E81AC] text-xs">Current Focus</p>
          </Reveal>
          ...
          <div className="mt-32 grid lg:grid-cols-12 gap-24">
            <div className="lg:col-span-4">
              <Reveal delay={0.2}>
                <span className="uppercase tracking-[0.4em] text-zinc-600 text-xs">Featured Project</span>
              </Reveal>
              <Reveal delay={0.3}>
              ...
              <div className="mt-20 space-y-12">
                <Reveal delay={0.45}>
                  <div className="border-l-2 border-[#5E81AC] pl-8">
                    <h4 className="text-white text-xl font-semibold">Architecture</h4>
                    <p className="mt-4 text-zinc-500 leading-8">
                      Multi-tenant architecture built with React, Node.js, Express and MongoDB.
                    </p>
                  </div>
                </Reveal>
                <Reveal delay={0.55}>
                  <div className="border-l-2 border-[#5E81AC] pl-8">
                    <h4 className="text-white text-xl font-semibold">Current Focus</h4>
                    <p className="mt-4 text-zinc-500 leading-8">
                      Authentication, RBAC, scalable APIs and production-ready engineering practices.
                    </p>
                  </div>
                </Reveal>
                <Reveal delay={0.65}>
                  <div className="border-l-2 border-[#5E81AC] pl-8">
                    <h4 className="text-white text-xl font-semibold">Long-Term Vision</h4>
                    <p className="mt-4 text-zinc-500 leading-8">
