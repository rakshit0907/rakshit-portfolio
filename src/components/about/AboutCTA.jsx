      ...
      <div className="relative z-10 max-w-7xl mx-auto px-10">
        ...
        <div className="grid lg:grid-cols-12 gap-24 mt-28">
          ...
          <div className="lg:col-span-5 flex lg:justify-end items-end">
            <Reveal delay={0.4}>
              <button
                className="group px-12 py-5 rounded-full border border-white text-white font-semibold transition-all duration-500 hover:bg-white hover:text-black hover:scale-105"
              >
