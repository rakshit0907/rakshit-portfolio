  ...
  return (
    <section className="about-tech relative -mt-32 py-60 bg-black overflow-hidden z-40">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-10">
        <ChapterFrame index={5} label="STACK">

          <Reveal y={30}>
            <p className="uppercase tracking-[0.45em] text-[#5E81AC] text-xs mb-8">Tech Ecosystem</p>
          </Reveal>
          ...
          <Reveal delay={0.2}>
            <div className="grid lg:grid-cols-12 gap-20 mt-28">
              <div className="lg:col-span-3">
                <p className="uppercase tracking-[0.45em] text-zinc-600 text-xs">MY STACK</p>
              </div>
            ...
            {techStack.map((tech, index) => {
              ...
              return (
                <Reveal key={tech.name} delay={index * 0.05}>
                  <div className="group border-t border-zinc-800 py-10 transition-all duration-500 hover:border-[#5E81AC]/40">
                    <div className="grid lg:grid-cols-12 gap-10 items-center">
                      <div className="lg:col-span-2">
                        <div className="transition-transform duration-500 group-hover:scale-110 group-hover:rotate-6">
                          <Icon size={tech.size ?? 52} color={tech.color} />
                        </div>
                      </div>
                      <div className="lg:col-span-4">
                        <h3 className="text-4xl font-black tracking-[-0.04em] transition-colors duration-300 group-hover:text-[#6F93BF]">
                          {tech.name}
                        </h3>
                      </div>
                      <div className="lg:col-span-6">
                        <p className="text-zinc-500 leading-8">{tech.description}</p>
                      </div>
                    </div>
                  </div>
                </Reveal>
