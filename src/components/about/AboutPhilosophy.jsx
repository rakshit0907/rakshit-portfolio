...
const principles = [
  { number: "01", title: "UNDERSTAND", desc: "Every great product begins by deeply understanding the problem before writing a single line of code." },
  { number: "02", title: "ENGINEER", desc: "Strong architecture and scalable systems create products that continue performing as they grow." },
  { number: "03", title: "REFINE", desc: "The smallest interactions often create the strongest impressions. Details are never accidental." },
];
  ...
  return (
    <section className="about-philosophy relative -mt-28 py-56 bg-black overflow-hidden z-30">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-10">
        <ChapterFrame index={4} label="PRINCIPLES">

          <Reveal y={30}>
            <p className="uppercase tracking-[0.5em] text-[#5E81AC] text-xs mb-8">Principles</p>
          </Reveal>
          ...
          <div className="grid lg:grid-cols-12 gap-20 mt-28">
            <div className="lg:col-span-3">
              <Reveal delay={0.2}>
                <p className="uppercase tracking-[0.45em] text-zinc-600 text-xs">WHY I BUILD</p>
              </Reveal>
            </div>
                ...
                <div className="border-t border-zinc-800 py-16">
                  <div className="grid lg:grid-cols-12 gap-12">
                    <div className="lg:col-span-2">
                      <span className="text-6xl font-black text-zinc-800 tracking-[-0.05em]">{item.number}</span>
                    </div>
                    <div className="lg:col-span-10">
                      <h3 className="text-4xl md:text-5xl font-black tracking-[-0.04em]">{item.title}</h3>
          ...
          <Reveal delay={0.4}>
            <div className="mt-32 border-t border-zinc-800 pt-16">
              ...
              <p className="mt-10 uppercase tracking-[0.45em] text-zinc-600 text-xs">— Rakshit Pandey</p>
            </div>
          </Reveal>
